...
import { loginSchema, registerSchema, registrationSchema } from '@/app/validationSchemas';
      ...
      <div className="sm:shadow-xl p-4 sm:bg-white rounded-xl max-w-2xl">
        ...
        >
          ...
          <div className='flex justify-center gap-3'>
            ...
            <Box>
              <Link  style={{ color: 'var(--accent-9)' }} className='hover:underline' href="/login">Sign up</Link>
            </Box>
          </div>
        </form>
